      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-bold tracking-widest text-gray-500 mb-8 uppercase">
              Headquarter
            </h4>
            ...
            <div className="flex items-center gap-3 pt-2 text-base">
              <FaPhoneAlt className="text-purple-500" />
              <span className="text-white text-base lg:text-base md:text-sm">(877)-555-6666</span>
            </div>
            <div className="flex items-center gap-3 text-base">
              <FaEnvelope className="text-purple-500 text-xl" />
              <span className="text-white text-base lg:text-base md:text-sm">info@domain.com</span>
            </div>
          </div>

          {/* Wrapper for Side-by-Side Mobile Layout */}
          {/* md:contents makes this div invisible to the grid layout on desktop */}
          <div className="flex flex-row gap-10 justify-between md:contents">
            {footerData.map((section: FooterSection) => (
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-500">
          <p className="text-center md:text-left">
            © 2025 · <span className="text-white">LazyDevs</span> · Template By
            <span className="text-purple-400 ml-1">LazyDevIT.Com</span>
          </p>
          <div className="flex gap-6">
